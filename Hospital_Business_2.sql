...
CREATE TABLE users_data(
	...
	type ENUM('passport','cuil','ruc'),
    doctype INT,
    nationality INT,
    address VARCHAR(50),
	phone VARCHAR(25), -- +(54911) 0303-4567
	email VARCHAR(150),
    PRIMARY KEY (id),
    UNIQUE KEY  (uid),
    UNIQUE KEY (
        ...
        phone,
        email),
        FOREIGN KEY(userId) REFERENCES users(id) -- campos_local => tabla(campo_relacional)
);
...
VALUES (1, 'Cristopher','Don','Robin','1991-04-18', 1, 1,'20-3553446-5', 1,'(54911)0303-4567','cristopher@gmail.com');
...
SELECT * FROM nationalities
WHERE nationality LIKE "paname_a";
TRUNCATE users_data;
